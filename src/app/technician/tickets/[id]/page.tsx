                      ...
                      <div className="flex items-center gap-2 shrink-0">
                        {file.url && (file.type === "image" || file.type === "pdf" || /\.(pdf|png|jpg|jpeg|webp|gif)$/i.test(file.name)) && (
                          <button
                            ...
                            className="rounded-lg border border-blue-500/40 bg-blue-600/20 px-2.5 py-1 text-[11px] font-semibold text-blue-300 hover:bg-blue-600/30 transition flex items-center gap-1 cursor-pointer"
