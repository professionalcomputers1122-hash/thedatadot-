...
interface DashboardKBItem {
  ...
  desc: string;
  link: string;
  iconType: "disc" | "package" | "fileText" | "cpu";
}

const dashboardKBGuides: DashboardKBItem[] = [
  {
    id: "kb-1",
    category: "Cleanroom Protocol",
    badge: "Emergency Protocol",
    title: "Clicking Drive Emergency Power Cut",
    desc: "Crucial instructions to prevent microscopic head scraping and permanent platter data loss.",
  ...
  },
  {
    ...
    badge: "Logistics & Packing",
    title: "Anti-Static & Courier Safe Packing",
    desc: "ESD shielding and 3-layer bubble cushioning guide for shipping media without transit shock.",
    link: "/customer/knowledge-base",
    iconType: "package",
  },
  {
    ...
    badge: "Dashboard Telemetry",
    title: "Understanding Your 4 Ticket Milestones",
    desc: "Detailed explanation of Media Intake, Cleanroom Diagnostics, PC-3000 Imaging, and Return.",
    link: "/customer/knowledge-base",
    iconType: "fileText",
  },
  {
    id: "kb-4",
    category: "Lab Attachments",
    badge: "Portal Feature",
    title: "Previewing & Downloading Lab Reports",
    desc: "How to inspect cleanroom microscope photos and download official PDF diagnostic sheets.",
    link: "/customer/knowledge-base",
    iconType: "cpu",
  },
];
...
interface DashboardFAQItem {
  id: string;
  category: "Data Recovery" | "Ticket Tracking" | "Courier & Packing" | "Guarantees & Security";
  question: string;
  answer: string;
}

const dashboardFAQs: DashboardFAQItem[] = [
  {
    id: "dash-faq-1",
    category: "Guarantees & Security",
    question: "What is your 'No Data, No Recovery Fee' guarantee?",
    answer:
      "If our cleanroom engineers are unable to recover your critical target files, you pay nothing. There are zero diagnostic bench fees, zero donor parts charges, and zero risk. You only pay after we successfully extract your files and verify data integrity.",
  },
  {
    id: "dash-faq-2",
    category: "Ticket Tracking",
    question: "What do the 4 progress stages in my dashboard mean?",
    answer:
      "Stage 1 (Media Intake): Your device is received, barcoded, and placed in our secure intake vault.\nStage 2 (Cleanroom Diagnostics): Certified engineers inspect mechanical donor heads and platters on an ISO Class-5 clean bench.\nStage 3 (PC-3000 Imaging): Non-destructive raw sector mirror extraction using hardware PC-3000 systems.\nStage 4 (Verification & Return): File directory integrity validation and secure return dispatch via encrypted drive or cloud link.",
  },
  {
    id: "dash-faq-3",
    category: "Ticket Tracking",
    ...
    answer:
      "On your active case spotlight or ticket detail view, check the 'Attached Laboratory Files & Diagnostics' panel. Click the eye icon on any photo to view in high resolution lightbox, or click the download icon to save official PDF bench reports directly to your computer.",
  },
  {
    id: "dash-faq-4",
    category: "Data Recovery",
    question: "Why should I immediately power down a clicking, grinding, or unreadable hard drive?",
    answer:
      "Clicking noises indicate that the mechanical read/write heads have dropped onto the rapidly spinning platters. Every second the drive spins, it physically scrapes away the microscopic magnetic layer, turning recoverable sectors into dust. Power off immediately and do not run chkdsk.",
  },
  {
    id: "dash-faq-5",
    category: "Courier & Packing",
    question: "How should I package my hard drive or SSD for courier transit?",
    answer:
      "Place each drive in an anti-static ESD bag, wrap with at least 3-4 layers of heavy-duty bubble wrap (minimum 2 inches of cushioning on all sides), pack inside a rigid corrugated cardboard box (never use a padded paper envelope), and clearly write your Ticket ID on the box.",
  },
  {
    id: "dash-faq-6",
    category: "Guarantees & Security",
    ...
    answer:
      "For volumes under 100 GB, we provide a 256-bit TLS encrypted, password-protected secure cloud download link. For larger volumes or full drives, data is transferred onto a brand-new, BitLocker-encrypted external hard drive shipped via insured courier or picked up at our cleanroom reception.",
  },
  {
    id: "dash-faq-7",
    category: "Guarantees & Security",
    question: "Is my confidential corporate or personal data protected under an NDA?",
    answer:
      "Yes. All forensic recoveries are executed inside a biometric-restricted facility operating under strict ISO Class-5 cleanroom and HIPAA/SOC-2 guidelines. Platter mirrors are stored on an isolated air-gapped storage array and securely purged 14 days after client verification.",
  },
];
...
export default function CustomerDashboardPage() {
  ...
  const [faqExpandedId, setFaqExpandedId] = useState<string | null>("dash-faq-1");
  ...
  const renderKBIcon = (type: DashboardKBItem["iconType"]) => {
    switch (type) {
      case "disc":
        return (
  ...
  return (
    <div className="min-h-screen bg-[#fafbfd] text-slate-900 flex flex-col antialiased">
      ...
      <main className="flex-1 max-w-7xl w-full mx-auto px-6 py-8">
        ...
        {/* CLIENT KNOWLEDGE BASE & HELP CENTER */}
        <div className="mt-8 space-y-8">
          {/* SECTION 1: KNOWLEDGE BASE QUICK GUIDES */}
          <div className="rounded-3xl border border-slate-200 bg-white p-6 sm:p-8 shadow-xs">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
              <div>
                <div className="inline-flex items-center gap-2 rounded-full border border-blue-200 bg-blue-50 px-2.5 py-0.5 text-[11px] font-bold text-blue-700 mb-1.5">
                  ...
                  <span>Knowledge Base &amp; Technical Procedures</span>
                </div>
                <h3 className="text-lg font-bold text-slate-950">
                  Client Hardware Guides &amp; Protocols
                </h3>
                <p className="text-xs text-slate-500">
                  Emergency hardware shut-off procedures, courier transit rules, and ticket telemetry guides.
                </p>
              </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
              {dashboardKBGuides.map((guide) => (
                <Link
                  key={guide.id}
                  href={guide.link}
                  className="group flex flex-col justify-between rounded-2xl border border-slate-200/90 bg-slate-50/50 p-5 hover:border-blue-300 hover:bg-white hover:shadow-sm transition"
                >
                  <div>
                    <div className="flex items-center justify-between mb-3">
                      <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-white border border-slate-200 shadow-2xs group-hover:border-blue-200 transition">
                        {renderKBIcon(guide.iconType)}
                      </div>
                      <span className="rounded-full bg-blue-50 px-2 py-0.5 text-[10px] font-extrabold text-blue-700 border border-blue-100">
                        {guide.badge}
                      </span>
                    </div>
          ...
          <div className="rounded-3xl border border-slate-200 bg-white p-6 sm:p-8 shadow-xs">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
              <div>
                ...
                <h3 className="text-lg font-bold text-slate-950">
                  Client Support &amp; Cleanroom FAQ
                </h3>
                <p className="text-xs text-slate-500">
                  Clear answers on No Data No Recovery Fee, laboratory attachments, courier drop-offs, and SLAs.
                </p>
              </div>
            ...
            <div className="mb-6 flex flex-col sm:flex-row gap-3">
              <div className="relative flex-1">
                <input
                  type="text"
                  placeholder="Search FAQ answers (e.g. 'attachments', 'guarantee', 'clicking', 'packaging')..."
                  value={faqSearch}
                  onChange={(e) => setFaqSearch(e.target.value)}
                  className="w-full rounded-xl border border-slate-300 bg-white p-2.5 pl-9 text-xs shadow-2xs outline-none focus:border-blue-600 focus:ring-2 focus:ring-blue-500/20"
                />
                <svg
              ...
              <div className="flex flex-wrap items-center gap-1.5">
                {["All", "Data Recovery", "Ticket Tracking", "Courier & Packing", "Guarantees & Security"].map((cat) => (
                  <button
                    key={cat}
                    type="button"
            ...
            <div className="space-y-3">
              {filteredFaqs.length > 0 ? (
                filteredFaqs.map((faq) => {
                  const isExp = faqExpandedId === faq.id;
                  return (
                    <div
                      key={faq.id}
                    ...
                    >
                      <button
                        type="button"
                        onClick={() => setFaqExpandedId(isExp ? null : faq.id)}
                        className="w-full text-left flex items-start justify-between gap-3 cursor-pointer"
                      >
                        <div>
                          <span className="inline-block rounded bg-blue-50 px-2 py-0.5 text-[9px] font-bold uppercase tracking-wider text-blue-700 border border-blue-100 mb-1">
                            {faq.category}
                          </span>
                        ...
                        <span className="flex h-6 w-6 shrink-0 items-center justify-center rounded-lg bg-slate-100 text-slate-600 font-bold text-xs">
                          {isExp ? "−" : "+"}
                        </span>
                      </button>

                      {isExp && (
                        <div className="mt-3 pt-3 border-t border-slate-100 text-xs text-slate-600 leading-relaxed whitespace-pre-line">
                          {faq.answer}
                        </div>
                      )}
                    </div>
            ...
            {/* HOTLINE BANNER */}
            <div className="mt-6 rounded-2xl bg-gradient-to-r from-slate-950 to-blue-950 p-5 text-white flex flex-col sm:flex-row items-center justify-between gap-4">
              <div className="flex items-center gap-3">
                <div className="flex h-9 w-9 items-center justify-center rounded-xl bg-blue-600/30 text-blue-300 border border-blue-500/30 shrink-0">
                  <svg className="w-4 h-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                    <path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z" />
                  </svg>
                </div>
                <div>
                  <p className="text-xs font-bold">Still have questions about your case or cleanroom dispatch?</p>
                  <p className="text-[11px] text-slate-300">Our engineering leads are available 24/7/365.</p>
                </div>
              </div>
              <a
